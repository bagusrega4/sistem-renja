...
<div class="container">
    <div class="page-inner">
        ...
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h2 class="fw-bold mb-3">Edit Form Tim Keuangan</h2>
                <h6 class="op-7 mb-2">Edit Form Upload File Tim Keuangan BPS Provinsi DKI Jakarta Tahun Anggaran 2025</h6>
            </div>
        ...
        <div class="card card-round">
            <div class="card-body">
                ...
                <form action="{{ route('monitoring.keuangan.update', $fp->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
