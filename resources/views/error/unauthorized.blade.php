...
<head>
    ...
    <title>Sistem BDA BPS DKI Jakarta</title>
...
<body class="index-page">
    ...
    <main class="main">
        <section id="unauthorized" class="hero section dark-background">
                ...
                <div class="row justify-content-center align-items-center text-center" style="min-height: 60vh;">
                    <div class="col-lg-8" data-aos="fade-up">
                        <h1 class="text-danger fw-bold">
                            <i class="bi bi-shield-exclamation"></i> Unauthorized Access
                        </h1>
                        <p class="lead">
